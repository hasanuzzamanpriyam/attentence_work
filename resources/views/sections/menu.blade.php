<ul>
    <!-- NAV ITEM - DASHBOARD -->
    @if (in_array('admin', user_roles()) || $sidebarUserPermissions['view_hr_dashboard'] == 4)
    ...
    @if (!in_array('client', user_roles()) && (in_array('employees', user_modules()) || in_array('leaves', user_modules()) || in_array('attendance', user_modules()) || in_array('holidays', user_modules())))
        <x-menu-item icon="people" :text="__('Management')">
            <x-slot name="iconPath">
                <path
            ...
            <div class="accordionItemContent">
                ...
                @if (in_array('attendance', user_modules()))
                    ...
                    @if (in_array('admin', user_roles()))
                        <x-sub-menu-item :link="'/account/device-logs'" text="Attendance Logs" />
                    @endif
                @endif
    ...
    <!-- NAV ITEM - SETTINGS (includes Role & Permissions) -->
    @if (in_array('admin', user_roles()))
        <x-menu-item icon="gear" :text="__('app.menu.settings')" :link="route('company-settings.index')">
            <x-slot name="iconPath">
                <path
    ...
    @else
        <x-menu-item icon="gear" :text="__('app.menu.settings')" :link="route('profile-settings.index')">
            <x-slot name="iconPath">
                <path
                    d="M8 4.754a3.246 3.246 0 1 0 0 6.492 3.246 3.246 0 0 0 0-6.492zM5.754 8a2.246 2.246 0 1 1 4.492 0 2.246 2.246 0 0 1-4.492 0z" />
                <path
