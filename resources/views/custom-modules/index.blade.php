                ...
                <div class="s-b-n-header" id="tabs">
                    <nav class="tabs px-4 border-bottom-grey">
                        <div class="nav" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link f-15 admin"
                                ...
                                <a class="nav-item nav-link f-15 custom active" href="{{ route('custom-modules.index') }}?tab=custom"
...
@push('scripts')
    <script>
        ...
        const activeTab = "{{ $activeTab ?? 'custom' }}";
